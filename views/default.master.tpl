    ...
    <footer class="page-footer sticky-footer">
      <div class="container">
        <div class="clearfix">
          ...
          <p class="pull-right hidden-xs">{t c="Built with"} <i class="InformSprite Heart"></i> {t c=","} <a href="http://getbootstrap.com">Bootstrap</a> {t c="and"} <a href="http://www.vanillaforums.org">Vanilla Forums</a>
